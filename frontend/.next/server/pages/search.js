...
// EXTERNAL MODULE: ./redux/actions/compare.ts
var compare = __webpack_require__("9J+5");
...
const ModuleCompareCode = ({
  ...
  const onDelete = () => {
    dispatch(Object(compare["b" /* deleteModuleAction */])(order));
  };
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return addModuleAction; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return deleteModuleAction; });
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("EHoS");

const addModuleAction = (_id, code) => {
  return {
    type: _constants__WEBPACK_IMPORTED_MODULE_0__[/* ADD_MODULE_FOR_COMPARISON */ "a"],
    payload: {
      id: _id,
      code
    }
...
const deleteModuleAction = order => {
  return {
    type: _constants__WEBPACK_IMPORTED_MODULE_0__[/* DELETE_MODULE_FOR_COMPARISON */ "b"],
    payload: order
  };
};
